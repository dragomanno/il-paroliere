...
export const indizio: LemmaEntry = {
  ...
  definition:
    "Elemento parziale che, pur non dimostrando da solo un fatto, lo rende più o meno probabile, orientando l'attenzione e la ricerca verso una certa ipotesi. Nel linguaggio giuridico l'indizio è un dato che, messo insieme ad altri e valutato nel suo complesso, può concorrere a formare prova, ma non basta da solo per condannare; in ambito quotidiano chiamiamo indizio qualsiasi traccia che suggerisce qualcosa — uno sguardo, una frase, un comportamento — anche quando il collegamento è più immaginato che fondato. Il valore di un indizio dipende tanto dalla sua forza intrinseca quanto dal modo in cui viene interpretato.",

  shortDefinition:
    "Traccia o elemento parziale che non dimostra da solo un fatto, ma lo rende più probabile e orienta ipotesi e sospetti.",

  etymology:
    "Dal latino inditium (più spesso indicium), “denuncia, segno rivelatore, indizio”, derivato di indicāre “mostrare, indicare”, da in- “verso” e dicere “dire”. In italiano il termine conserva il nucleo di “segno che parla di qualcos'altro”, con specializzazione nel linguaggio giuridico e investigativo.",
  ...
  relatedWords: ["prova", "dubbio", "sospetto", "presunzione-di-innocenza"],
  ...
  seo: {
    ...
    description:
      "Che cos'è un indizio tra diritto, indagine e vita quotidiana, dalle tracce che orientano le ipotesi ai rischi di vedere prove dove ci sono solo sospetti.",
  },
