...
export const filosofia: LemmaEntry = {
  ...
  definition:
    "Insieme di attività di pensiero che interrogano in modo critico e argomentato i concetti più generali con cui abitiamo il mondo — essere, verità, bene, giustizia, tempo, conoscenza — senza limitarsi a ciò che appare ovvio. Storicamente la filosofia è anche una disciplina con tradizioni, scuole e metodi diversi, dalla dialettica antica alle analisi del linguaggio, dalle riflessioni sull'esperienza quotidiana alle discussioni sulla scienza e sulla tecnica. Nel linguaggio comune, “farsi una filosofia” significa darsi un modo di vedere la vita, più o meno coerente, che aiuta a reggere ciò che accade.",
  ...
  etymology:
    "Dal latino philosophia, a sua volta dal greco philósophia, “amore per la sapienza”, composto da phileîn “amare” e sophía “sapienza, sapere”. Nella Grecia antica indicava un atteggiamento di ricerca più che un possesso di verità; nel tempo è diventata nome di una disciplina con confini variabili rispetto alle scienze e alle religioni.",
  ...
  relatedWords: ["metafisica", "epistemologia", "dialettica", "sociologia"],
  ...
  seo: {
    ...
    description:
      "Che cos'è la filosofia tra etimologia, storia e uso quotidiano, dal pensiero critico sulle idee di sempre alle “filosofie di vita” con cui affrontiamo il presente.",
  },
