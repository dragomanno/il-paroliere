...
export const amnesia: LemmaEntry = {
  ...
  relatedWords: ["memoria", "oblio", "trauma", "dissociazione"],
  ...
  seo: {
    ...
    description:
      "Che cos'è l'amnesia tra perdita di memoria neurologica, traumi psicologici e amnesia collettiva usata come comoda rimozione.",
  },
